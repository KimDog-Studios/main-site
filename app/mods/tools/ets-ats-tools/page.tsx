            ...
            <Box className={styles.descriptionBox}>
              ...
              >
                <Typography className="mb-4">
                  This Tools pack contains software that lets you customize and expand your existing Euro Truck Simulator 2 (ETS2) and American Truck Simulator (ATS) game.
                </Typography>
                <Typography className="mb-4">
                  Enjoy the tools pack! Packed by KimDog-Studios!
                </Typography>
