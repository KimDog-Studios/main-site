...
import { mods as allMods, verifiedAuthors, Mod, dlcs as allDlcs } from '@/components/Main'; // Import data script
...
const Page: React.FC = () => {
  ...
  const filteredDLC = filterAndSearchItems(allDlcs, selectedFilters, searchQuery);

  // Combine mods and DLCs
  const combinedItems = [...filteredMods, ...filteredDLC];
                ...
                <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6'>
                  {groupedItems[game].map(item => (
                    ...
                    >
                      ...
                      <Tooltip title={`Downloads: ${item.downloadCount}`} arrow>
